...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 5px;
            width: 56mm; /* Ukuran Thermal 58mm */
        }
...
<div class="text-center">
    <h2 style="margin:0; font-size: 14px;">{{ $settings['business_name'] ?? config('app.name') }}</h2>
    <p style="margin:2px 0; font-size: 10px;">{{ $settings['address'] ?? 'Jl. Bengkel No. 1' }}</p>
    <p style="margin:2px 0; font-size: 10px;">{{ $transaction->created_at->format('d/m/Y H:i') }}</p>
</div>
...
<div class="text-center" style="margin-top: 8px;">
    ...
    <p style="font-size: 9px; margin-top:2px; color:grey;">Powered by {{ config('app.name') }}</p>
</div>
